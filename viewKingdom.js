...
//----------------------------------AUTO MODE------------------------
function startInfoKingdomAuto (kingdomAuto) {
    var battleContainer = document.querySelector('.start-container'),
        info = document.createElement('div')/*,
        attack = document.createElement('button')*/;
        ...
        /*attack.classList.add('btn-attack--kingdom');
        attack.innerHTML = "Kingdom attacks!";*/
        info.classList.add('info-kingdomAuto');
        info.innerHTML = kingdomAuto.power + "<span>&nbsp;- Kingdom's Start Power,</span><br>" 
        + kingdomAuto.health + "<span>&nbsp;- Kingdom's Start Health;</span>";
        battleContainer.appendChild(info);
        /*info.appendChild(attack); */
}

function infoKingdomAfterAttackAuto(kingdomAuto) {
    var battleContainer = document.querySelector('.start-container'),
        infoAfter = document.createElement('div'),
        allHealth = Number(),
        allPower = Number();
        allHealth = kingdomHealth(kingdomAuto);
        allPower = kingdomPower(kingdomAuto);
